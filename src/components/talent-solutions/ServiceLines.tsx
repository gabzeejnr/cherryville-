...
import { ServiceLines } from "./talentSolutions.types";

function Card({ service }: { service: ServiceLines }) {
    return (
        <div className="flex flex-col gap-5 bg-cherry p-4 shadow-lg rounded-2xl sm:max-h-80 md:max-h-75 md:pb-5 lg:h-70 justify-center-safe">

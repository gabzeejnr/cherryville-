    ...
    <div className="rounded-2xl overflow-hidden border-2 border-black/10 shadow-xl bg-white flex flex-col">
      <div className="px-7 pt-8 pb-10" style={{ backgroundColor: area.headerBg }}>
        <div className="flex items-start justify-between mb-6">
          ...
          <span className="text-[10px] tracking-[0.15em] font-bold text-white/60 mt-1 uppercase">
            {area.label}
          </span>
        </div>
        <h3 className="text-white text-2xl font-extrabold tracking-tight">{area.title}</h3>
      </div>

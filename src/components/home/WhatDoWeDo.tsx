...
function Card({ doing }: { doing: Doings }) {
    ...
    return (
        <div className="rounded-2xl overflow-hidden shadow-sm bg-white flex flex-col h-auto sm:h-85 md:h-90 hover:shadow-2xl hover:-translate-y-3 transition-all duration-500">
